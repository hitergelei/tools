...
if __name__ == '__main__':
    ...
    print('')
    print('Useage  ==> ./ase-rdf.py >1st_spec< >2nd_spec< >atoms list file< >rMax< >nBins< (>rectify_cut<)'.center(120))
    print('Example 1 ==> ./ase-rdf.py all all si.traj 12 500 0.2                              '.center(120))
    print('Example 2 ==> ./ase-rdf.py  Ge  Te si.traj 12 500 0.2                              '.center(120))
    print('')
