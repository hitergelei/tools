...
for i in iter_range:
    ...
    lines = [
        ...
        'fix          NPT all npt/omp temp ${T} ${T} 1. aniso 0 0 1.0\n',
        ...
        '\n',
        'unfix       NPT\n',
        # 'fix         NPT all npt/omp temp ${T} ${T} 100. aniso 0 0 100.0\n',
        'fix         NVE all nve/omp\n',
        # '\n',
        'reset_timestep 0\n',
        'timestep     ${dt}\n',
    ...
    call('cp run.sh frozen_model.pb structure.in job-{}/'.format(i), shell=True)
    # Write input file
