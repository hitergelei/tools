...
for i in iter_range:
    ...
    lines = [
        ...
        'dump         0 all custom 100 pre-out.dump id element mass type x y z fx fy fz vx vy vz\n',
        'dump_modify  0 element Ga N\n',
        'run          5000\n',
        'undump       0\n',
        # '\n',
        # 'unfix        NVT\n',
        ...
        'thermo       100\n',
        'log          log.lammps\n',
        'dump         1 all custom 100 out.dump id element mass type x y z fx fy fz vx vy vz c_myPE\n',
