...
volu = []
for i in load_range:
    # fname = 'job-{}/kappa-whole/lmp-results.traj_dt{}_c{}_n{}_a{}_t{}_b{}_c{}.npy'.format(i, dt, corr_len, img_slice, avg_intvl, two_term, sub_bind, w_convec)
    fname = 'job-{}/kappa-whole/unfold_lmp-results.traj_dt{}_c{}_n{}_a{}_t{}_b{}_c{}_e{}.npy'.format(i, dt, corr_len, img_slice, avg_intvl, two_term, sub_bind, w_convec, center)
