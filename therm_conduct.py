...
def argparse():
    ...
    parser.add_argument('-u', '--avg_intvl', type=int, default=1, help='Interval between HFACF average in unit of steps')
...
if __name__ == '__main__':
    ...
    # # @ Devide box
    # # Shape = (num_avg_steps, len(atoms))
    # masker = classify_atoms(posi[:avg_intvl*num_avg_steps:avg_intvl], latt[:avg_intvl*num_avg_steps:avg_intvl])
    ...
    ax1.tick_params(axis="y",direction="in", labelsize='x-large', labelcolor='b')
    ax2.tick_params(axis="y",direction="in", labelsize='x-large',colors='r',  labelcolor='r')
    plt.title('IS={}, NAS={}, AI={}, $\sigma$={}'.format(img_slice, num_avg_steps, avg_intvl, gauss_sigma), fontsize='x-large')
